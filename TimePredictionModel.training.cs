...
namespace Grosu_Andrada_Lab4
{
    public partial class TimePredictionModel
    {
        public const string RetrainFilePath =  @"C:\Users\Andrada\Downloads\fare-train-data.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options(){NumberOfLeaves=4,NumberOfIterations=2553,MinimumExampleCountPerLeaf=20,LearningRate=0.28149134460794584,LabelColumnName=@"trip_time_in_secs",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.37382868343647463,FeatureFraction=0.960564473035903,L1Regularization=5.411641818552847E-10,L2Regularization=0.4537263878437779},MaximumBinCountPerFeature=341}));
